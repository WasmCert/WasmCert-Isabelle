...
proof -
  ...
  next
    ...
    thus ?thesis
      ...
      by (auto simp add: const_list_def is_const_def Suc_1[symmetric] glob_typing_def nth_append sglob_def sglob_ind_def sglob_val_def app_s_f_v_s_get_global_def split: prod.splits)
  qed
qed
