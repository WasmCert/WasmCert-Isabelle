...
| memory_init_trap: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; x < length (inst.datas (f_inst f)); da =(inst.datas (f_inst f))!x; dat = (datas s)!da; src+n > length dat \<or>  dest+n > mem_length m \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat n)),$Memory_init x]\<rparr> \<leadsto> \<lparr>s;f;[Trap]\<rparr>"
| memory_init_done: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; x < length (inst.datas (f_inst f)); da =(inst.datas (f_inst f))!x; dat = (datas s)!da; src \<le> length dat;  dest \<le> mem_length m \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 0),$Memory_init x]\<rparr> \<leadsto> \<lparr>s;f;[]\<rparr>"
| memory_init: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; x < length (inst.datas (f_inst f)); da =(inst.datas (f_inst f))!x; dat = (datas s)!da; src+n+1 \<le> length dat;  dest+n \<le> mem_length m; b = nat_of_uint8 (dat!src) \<rbrakk> \<Longrightarrow>
  \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat (n+1))),$Memory_init x]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat (d+1))), $EConstNum (ConstInt32 (int_of_nat b)), $Store T_i32 (Some Tp_i8) 0 0, $EConstNum (ConstInt32 (int_of_nat (dest+1))), $EConstNum (ConstInt32 (int_of_nat (src+1))), $EConstNum (ConstInt32 (int_of_nat (n))) ,$Memory_init x]\<rparr>"


| memory_copy_trap: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; src+n > mem_length m \<or>  dest+n > mem_length m \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat n)),$Memory_copy]\<rparr> \<leadsto> \<lparr>s;f;[Trap]\<rparr>"
| memory_copy_done: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; src \<le> mem_length m;  dest \<le> mem_length m \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat 0)),$Memory_copy]\<rparr> \<leadsto> \<lparr>s;f;[]\<rparr>"
| memory_copy_1: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; src+n+1 \<le> mem_length m; dest+n+1\<le> mem_length m; dest \<le> sz\<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat (n+1))), $Memory_copy]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $Load T_i32 (Some (Tp_i8, U)) 0 0, $Store T_i32 (Some Tp_i8) 0 0, $EConstNum (ConstInt32 (int_of_nat (dest+1))), $EConstNum (ConstInt32 (int_of_nat (src+1))), $EConstNum (ConstInt32 (int_of_nat (n))), $Memory_copy]\<rparr>"
| memory_copy_2: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; src+n+1 \<le> mem_length m; dest+n+1 \<le> mem_length m; dest > sz\<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat (n+1))), $Memory_copy]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat (dest+n))), $EConstNum (ConstInt32 (int_of_nat (src+n))), $Load T_i32 (Some (Tp_i8, U)) 0 0, $Store T_i32 (Some Tp_i8) 0 0, $EConstNum (ConstInt32 (int_of_nat (dest))), $EConstNum (ConstInt32 (int_of_nat (src))), $EConstNum (ConstInt32 (int_of_nat (n))), $Memory_copy]\<rparr>"


| memory_fill_trap: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; dest+n > mem_length m \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 val), $EConstNum (ConstInt32 (int_of_nat n)),$Memory_fill]\<rparr> \<leadsto> \<lparr>s;f;[Trap]\<rparr>"
| memory_fill_done: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; dest \<le> mem_length m \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 val), $EConstNum (ConstInt32 (int_of_nat 0)),$Memory_fill]\<rparr> \<leadsto> \<lparr>s;f;[]\<rparr>"
| memory_fill: "\<lbrakk>smem_ind (f_inst f) = Some ma; (mems s)!ma = m; dest+n+1 \<le> mem_length m \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 val), $EConstNum (ConstInt32 (int_of_nat (n+1))),$Memory_fill]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 val), $Store T_i32 (Some Tp_i8) 0 0, $EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 val), $EConstNum (ConstInt32 (int_of_nat (n))) ,$Memory_fill]\<rparr>"
...
| table_init: "\<lbrakk>stab_ind (f_inst f) x = Some ta; (tabs s)!ta = tab; y < length (inst.elems (f_inst f)); ea = (inst.elems (f_inst f))!y; el = (elems s)!ea; ndest = nat_of_int dest; nsrc = nat_of_int src; nn = nat_of_int n; nsrc + nn \<le> length (snd el); ndest + nn  \<le> length (snd tab); nn = n'+1; val = (snd el)!nsrc\<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 dest), $EConstNum (ConstInt32 src), $EConstNum (ConstInt32 n),$Table_init x y]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 dest), $C (V_ref val), $Table_set x, $EConstNum (ConstInt32 (int_of_nat (ndest+1))), $EConstNum (ConstInt32 (int_of_nat (nsrc+1))), $EConstNum (ConstInt32 (int_of_nat n')), $Table_init x y]\<rparr>"

(*
| table_init_trap: "\<lbrakk>stab_ind (f_inst f) x = Some ta; (tabs s)!ta = tab; y < length (inst.elems (f_inst f));  ea = (inst.elems (f_inst f))!y; el = (elems s)!ea; src+n > length (snd el) \<or> dest+n > length (snd tab)\<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat n)),$Table_init x y]\<rparr> \<leadsto> \<lparr>s;f;[Trap]\<rparr>"
| table_init_done: "\<lbrakk>stab_ind (f_inst f) x = Some ta; (tabs s)!ta = tab; y < length (inst.elems (f_inst f)); ea = (inst.elems (f_inst f))!y; el = (elems s)!ea; src \<le> length (snd el); dest \<le> length (snd tab)\<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 0),$Table_init x y]\<rparr> \<leadsto> \<lparr>s;f;[]\<rparr>"
| table_init: "\<lbrakk>stab_ind (f_inst f) x = Some ta; (tabs s)!ta = tab; y < length (inst.elems (f_inst f)); ea = (inst.elems (f_inst f))!y; el = (elems s)!ea; src+n+1 \<le> length (snd el); dest+n+1 \<le> length (snd tab); val = (snd el)!src\<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat (n+1))),$Table_init x y]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $C (V_ref val), $Table_set x, $EConstNum (ConstInt32 (int_of_nat (dest+1))), $EConstNum (ConstInt32 (int_of_nat (src+1))), $EConstNum (ConstInt32 (int_of_nat n)), $Table_init x y]\<rparr>"
*)



| table_fill_trap: "\<lbrakk>stab_ind (f_inst f) x = Some ta; (tabs s)!ta = tab; i+n > length (snd tab) \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat i)), $C (V_ref vr), $EConstNum (ConstInt32 (int_of_nat n)),$Table_fill x]\<rparr> \<leadsto> \<lparr>s;f;[Trap]\<rparr>"
| table_fill_done: "\<lbrakk>stab_ind (f_inst f) x = Some ta; (tabs s)!ta = tab; i \<le> length (snd tab) \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat i)), $C (V_ref vr), $EConstNum (ConstInt32 (int_of_nat 0)),$Table_fill x]\<rparr> \<leadsto> \<lparr>s;f;[]\<rparr>"
| table_fill: "\<lbrakk>stab_ind (f_inst f) x = Some ta; (tabs s)!ta = tab; i+n+1 \<le> length (snd tab) \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat i)), $C (V_ref vr), $EConstNum (ConstInt32 (int_of_nat (n+1))),$Table_fill x]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat i)), $C (V_ref vr), $Table_set x, $EConstNum (ConstInt32 (int_of_nat (i+1))), $C (V_ref val), $EConstNum (ConstInt32 (int_of_nat n)), $Table_fill x]\<rparr>"

| table_copy_trap: "\<lbrakk>stab_ind (f_inst f) x = Some tax; (tabs s)!tax = tabx; stab_ind (f_inst f) y = Some tay; (tabs s)!ty = taby; src+n > length (snd tabx) \<or> dest+n > length (snd taby) \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat n)),$Table_copy x y]\<rparr> \<leadsto> \<lparr>s;f;[Trap]\<rparr>"
| table_copy_done: "\<lbrakk>stab_ind (f_inst f) x = Some tax; (tabs s)!tax = tabx; stab_ind (f_inst f) y = Some tay; (tabs s)!ty = taby; src \<le> length (snd tabx); dest \<le> length (snd taby) \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat 0)),$Table_copy x y]\<rparr> \<leadsto> \<lparr>s;f;[]\<rparr>"
| table_copy_1: "\<lbrakk>stab_ind (f_inst f) x = Some tax; (tabs s)!tax = tabx; stab_ind (f_inst f) y = Some tay; (tabs s)!ty = taby; src+n+1 \<le> length (snd tabx); dest+n+1 \<le> length (snd taby); dest \<le> src \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat (n+1))),$Table_copy x y]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $Table_get y, $Table_set x, $EConstNum (ConstInt32 (int_of_nat (dest+1))), $EConstNum (ConstInt32 (int_of_nat (src+1))), $EConstNum (ConstInt32 (int_of_nat n)), $Table_copy x y]\<rparr>"
| table_copy_2: "\<lbrakk>stab_ind (f_inst f) x = Some tax; (tabs s)!tax = tabx; stab_ind (f_inst f) y = Some tay; (tabs s)!ty = taby; src+n+1 \<le> length (snd tabx); dest+n+1 \<le> length (snd taby); dest > src \<rbrakk> \<Longrightarrow> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat dest)), $EConstNum (ConstInt32 (int_of_nat src)), $EConstNum (ConstInt32 (int_of_nat (n+1))),$Table_copy x y]\<rparr> \<leadsto> \<lparr>s;f;[$EConstNum (ConstInt32 (int_of_nat (dest+n))), $EConstNum (ConstInt32 (int_of_nat (src+n))), $Table_get y, $Table_set x, $EConstNum (ConstInt32 (int_of_nat (dest))), $EConstNum (ConstInt32 (int_of_nat (src))), $EConstNum (ConstInt32 (int_of_nat n)), $Table_copy x y]\<rparr>"
