...
module WasmRef_Isa : sig
  ...
  type minmaxop_vec_i = Min_vec of sx | Max_vec of sx
  type shape_vec_i = I8_16 | I16_8 | I32_4 | I64_2
  type shape_vec_f = F32_4 | F64_2
  type satop_vec_i = Add_sat_vec of sx | Sub_sat_vec of sx
  type relop_vec_i = Eq_vec | Ne_vec | Lt_vec of sx | Gt_vec of sx |
    Le_vec of sx | Ge_vec of sx
  type relop_vec_f = Eq_vecf | Ne_vecf | Lt_vecf | Gt_vecf | Le_vecf | Ge_vecf
  type binop_vec_v = And_vec | Andnot_vec | Or_vec | Xor_vec
  type binop_vec_i = Add_vec | Sub_vec
  type binop_vec_f = Add_vecf | Sub_vecf | Mul_vecf | Div_vecf | Min_vecf |
    Max_vecf | Pmin_vecf | Pmax_vecf
  type half_vec = High_vec | Low_vec
  type binop_vec = Binop_vec_v of binop_vec_v | Swizzle_i8_16 |
    Binop_vec_i of binop_vec_i * shape_vec_i |
    Binop_vec_f of binop_vec_f * shape_vec_f | Minmaxop_i8_16 of minmaxop_vec_i
    | Minmaxop_i16_8 of minmaxop_vec_i | Minmaxop_i32_4 of minmaxop_vec_i |
    Satop_i8_16 of satop_vec_i | Satop_i16_8 of satop_vec_i | Mul_i16_8 |
    Mul_i32_4 | Mul_i64_2 | Avgr_u_i8_16 | Avgr_u_i16_8 | Q15mulr_sat_s_i16_8 |
    Relop_i8_16 of relop_vec_i | Relop_i16_8 of relop_vec_i |
    Relop_i32_4 of relop_vec_i | Relop_i64_2_eq | Relop_i64_2_ne |
    Relop_i64_2_lt_s | Relop_i64_2_gt_s | Relop_i64_2_le_s | Relop_i64_2_ge_s |
    Relop_vec_f of relop_vec_f * shape_vec_f | Narrow_i8_16_i16_8 of sx |
    Narrow_i16_8_i32_4 of sx | Dot_s_i32_4_i16_8 |
    Extmul_i16_8_i8_16 of half_vec * sx | Extmul_i32_4_i16_8 of half_vec * sx |
    Extmul_i64_2_i32_4 of half_vec * sx
  val typerep_binop_veca : binop_vec itself -> typerepa
  val typerep_binop_vec : binop_vec typerep
  ...
  type shiftop_vec = Shl_vec of shape_vec_i | Shr_vec of shape_vec_i * sx
  type testop_vec = Any_true_vec | All_true_vec of shape_vec_i |
    Bitmask_vec of shape_vec_i
  type ternop_vec = Bitselect_vec
  ...
  type unop_vec_v = Not_vec
  type unop_vec_i = Abs_vec | Neg_vec
  type unop_vec_f = Abs_vecf | Neg_vecf | Sqrt_vecf | Ceil_vecf | Floor_vecf |
    Trunc_vecf | Nearest_vecf
  type cvtop_vec = Extend_i16_8_i8_16 of half_vec * sx |
    Extend_i32_4_i16_8 of half_vec * sx | Extend_i64_8_i32_4 of half_vec * sx |
    Trunc_sat_i32_4_f_32_4 of sx | Trunc_sat_i32_4_f_64_2_zero of sx |
    Convert_f32_4_i32_4 of sx | Demote_f32_4_f64_2_zero |
    Convert_low_f64_2_i32_4 of sx | Promote_low_f64_2_f32_4
  type unop_vec = Unop_vec_v of unop_vec_v |
    Unop_vec_i of unop_vec_i * shape_vec_i |
    Unop_vec_f of unop_vec_f * shape_vec_f | Cvt_vec of cvtop_vec | Popcnt_i8_16
    | Extadd_pairwise_i16_8_i8_16 of sx | Extadd_pairwise_i32_4_i16_8 of sx
  ...
  type b_e = Unreachable | Nop | Drop | Select | Block of tf * b_e list |
    ...
    Cvtop of t_num * cvtop * t_num * (sat * sx) option | Unop_vec of unop_vec |
    Binop_vec of binop_vec | Shuffle_i8_16 of nat list |
    Ternop_vec of ternop_vec | Test_vec of testop_vec | Shift_vec of shiftop_vec
    | Splat_vec of shape_vec | Extract_vec of shape_vec * sx * nat |
    Replace_vec of shape_vec * nat
  ...
  val ocaml_app_test_vec_v : testop_vec -> V128Wrapper.t -> i32
  val app_test_vec_v : testop_vec -> V128Wrapper.t -> i32
  val app_test_vec : testop_vec -> v_vec -> i32
  val ocaml_app_unop_vec_v_v : unop_vec_v -> V128Wrapper.t -> V128Wrapper.t
  val ocaml_app_unop_vec_i_v :
    unop_vec_i -> shape_vec_i -> V128Wrapper.t -> V128Wrapper.t
  val ocaml_app_unop_vec_f_v :
    unop_vec_f -> shape_vec_f -> V128Wrapper.t -> V128Wrapper.t
  val ocaml_app_cvt_vec_v : cvtop_vec -> V128Wrapper.t -> V128Wrapper.t
  val ocaml_app_unop_vec_v : unop_vec -> V128Wrapper.t -> V128Wrapper.t
  val app_unop_vec_v : unop_vec -> V128Wrapper.t -> V128Wrapper.t
  val app_unop_vec : unop_vec -> v_vec -> v_vec
  ...
  val ocaml_app_minmax_vec_i_v :
    minmaxop_vec_i ->
      shape_vec_i -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t option
  val ocaml_app_satop_vec_i_v :
    satop_vec_i ->
      shape_vec_i -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t option
  val ocaml_app_relop_vec_i_v :
    relop_vec_i ->
      shape_vec_i -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t option
  val ocaml_app_relop_vec_f_v :
    relop_vec_f ->
      shape_vec_f -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t option
  val ocaml_app_binop_vec_i_v :
    binop_vec_i ->
      shape_vec_i -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t option
  val ocaml_app_binop_vec_f_v :
    binop_vec_f ->
      shape_vec_f -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t option
  val ocaml_app_binop_vec_v :
    binop_vec -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t option
  val app_binop_vec_v :
    binop_vec -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t option
  val app_binop_vec : binop_vec -> v_vec -> v_vec -> v_vec option
  val ocaml_app_shift_vec_v :
    shiftop_vec -> V128Wrapper.t -> i32 -> V128Wrapper.t
  val app_shift_vec_v : shiftop_vec -> V128Wrapper.t -> i32 -> V128Wrapper.t
  val app_shift_vec : shiftop_vec -> v_vec -> i32 -> v_vec
  ...
  val ocaml_app_shuffle_vec_v :
    nat list -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t
  val app_shuffle_vec_v :
    nat list -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t
  val app_shuffle_vec : nat list -> v_vec -> v_vec -> v_vec
  val app_v_s_shuffle_vec : nat list -> v list -> v list * res_step
  ...
  val ocaml_app_ternop_vec_v :
    ternop_vec ->
      V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t
  val app_ternop_vec_v :
    ternop_vec ->
      V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t -> V128Wrapper.t
  val app_ternop_vec : ternop_vec -> v_vec -> v_vec -> v_vec -> v_vec
  val app_v_s_ternop_vec : ternop_vec -> v list -> v list * res_step
  val app_v_s_tee_local : nat -> v list -> v list * (e list * res_step)
  val app_v_s_splat_vec : shape_vec -> v list -> v list * res_step
  val app_v_s_shift_vec : shiftop_vec -> v list -> v list * res_step
  val app_v_s_binop_vec : binop_vec -> v list -> v list * res_step
  val app_v_s_unop_vec : unop_vec -> v list -> v list * res_step
  val app_v_s_test_vec : testop_vec -> v list -> v list * res_step
...
type relop_vec_i = Eq_vec | Ne_vec | Lt_vec of sx | Gt_vec of sx | Le_vec of sx
  | Ge_vec of sx;;
...
let rec typerep_binop_veca t = Typerep ("Wasm_Ast.binop_vec", []);;

let typerep_binop_vec = ({typerep = typerep_binop_veca} : binop_vec typerep);;
...
type b_e = Unreachable | Nop | Drop | Select | Block of tf * b_e list |
  ...
  Testop of t_num * testop | Relop of t_num * relop |
  Cvtop of t_num * cvtop * t_num * (sat * sx) option | Unop_vec of unop_vec |
  Binop_vec of binop_vec | Shuffle_i8_16 of nat list | Ternop_vec of ternop_vec
  | Test_vec of testop_vec | Shift_vec of shiftop_vec | Splat_vec of shape_vec |
...
and check_single
  c x1 ts = match c, x1, ts with
    ...
    | c, Binop_vec op, ts ->
        type_update ts [TSome (T_vec T_v128); TSome (T_vec T_v128)]
          (Typea [T_vec T_v128])
    | c, Shuffle_i8_16 is, ts ->
        (if equal_nat (size_list is) (nat_of_integer (Z.of_int 16)) &&
              list_all (fun i -> less_nat i (nat_of_integer (Z.of_int 32))) is
...
let rec sx_b sx = (match sx with S -> true | U -> false);;
      ...
      (bind (single (x, xa))
        (fun a ->
          (match a with (_, Unreachable) -> bot_pred | (_, Nop) -> bot_pred
            ...
            | (_, Binop_vec _) -> bot_pred | (_, Shuffle_i8_16 _) -> bot_pred
...
let rec half_vec_b h = (match h with High_vec -> true | Low_vec -> false);;
...
let rec ocaml_app_test_vec_v
  op v1 =
    (match op with Any_true_vec -> wasm_bool (V128Wrapper.any_true_vec v1)
      | All_true_vec svi ->
        wasm_bool
          (V128Wrapper.all_true_vec (integer_of_nat (vec_i_length svi)) v1)
      | Bitmask_vec svi ->
        ocaml_int32_to_isabelle_int32
          (V128Wrapper.bitmask_vec (integer_of_nat (vec_i_length svi)) v1));;

let rec app_test_vec_v x = ocaml_app_test_vec_v x;;

let rec app_test_vec op v1 = (let ConstVec128 a = v1 in app_test_vec_v op a);;

let rec ocaml_app_unop_vec_v_v
  op v = (let Not_vec = op in V128Wrapper.not_vec_v v);;

let rec ocaml_app_unop_vec_i_v
  op svi v =
    (let n = integer_of_nat (vec_i_length svi) in
      (match op with Abs_vec -> V128Wrapper.abs_vec_i n v
        | Neg_vec -> V128Wrapper.neg_vec_i n v));;

let rec ocaml_app_unop_vec_f_v
  op svf v =
    (let n = integer_of_nat (vec_f_length svf) in
      (match op with Abs_vecf -> V128Wrapper.abs_vec_f n v
        | Neg_vecf -> V128Wrapper.neg_vec_f n v
        | Sqrt_vecf -> V128Wrapper.sqrt_vec_f n v
        | Ceil_vecf -> V128Wrapper.ceil_vec_f n v
        | Floor_vecf -> V128Wrapper.floor_vec_f n v
        | Trunc_vecf -> V128Wrapper.trunc_vec_f n v
        | Nearest_vecf -> V128Wrapper.nearest_vec_f n v));;

let rec ocaml_app_cvt_vec_v
  op v =
    (match op
      with Extend_i16_8_i8_16 (h, sx) ->
        V128Wrapper.cvt_extend_vec (Z.of_int 2) (Z.of_int 1) (half_vec_b h)
          (sx_b sx) v
      | Extend_i32_4_i16_8 (h, sx) ->
        V128Wrapper.cvt_extend_vec (Z.of_int 4) (Z.of_int 2) (half_vec_b h)
          (sx_b sx) v
      | Extend_i64_8_i32_4 (h, sx) ->
        V128Wrapper.cvt_extend_vec (Z.of_int 8) (Z.of_int 4) (half_vec_b h)
          (sx_b sx) v
      | Trunc_sat_i32_4_f_32_4 sx ->
        V128Wrapper.cvt_trunc_sat_vec_i_f (Z.of_int 4) (Z.of_int 4) (sx_b sx) v
      | Trunc_sat_i32_4_f_64_2_zero sx ->
        V128Wrapper.cvt_trunc_sat_zero_vec_i_f (Z.of_int 4) (Z.of_int 8)
          (sx_b sx) v
      | Convert_f32_4_i32_4 sx ->
        V128Wrapper.cvt_convert_vec_f_i (Z.of_int 4) (Z.of_int 4) (sx_b sx) v
      | Demote_f32_4_f64_2_zero ->
        V128Wrapper.cvt_demote_vec_f_f (Z.of_int 4) (Z.of_int 8) v
      | Convert_low_f64_2_i32_4 sx ->
        V128Wrapper.cvt_convert_low_vec_f_i (Z.of_int 8) (Z.of_int 4) (sx_b sx)
          v
      | Promote_low_f64_2_f32_4 ->
        V128Wrapper.cvt_promote_low_vec_f_f (Z.of_int 8) (Z.of_int 4) v);;

let rec ocaml_app_unop_vec_v
  uop v =
    (match uop with Unop_vec_v op -> ocaml_app_unop_vec_v_v op v
      | Unop_vec_i (op, sv) -> ocaml_app_unop_vec_i_v op sv v
      | Unop_vec_f (op, sv) -> ocaml_app_unop_vec_f_v op sv v
      | Cvt_vec op -> ocaml_app_cvt_vec_v op v
      | Popcnt_i8_16 -> V128Wrapper.popcnt_vec (Z.of_int 1) v
      | Extadd_pairwise_i16_8_i8_16 sx ->
        V128Wrapper.extadd_pairwise (Z.of_int 2) (sx_b sx) v
      | Extadd_pairwise_i32_4_i16_8 sx ->
        V128Wrapper.extadd_pairwise (Z.of_int 4) (sx_b sx) v);;

let rec app_unop_vec_v x = ocaml_app_unop_vec_v x;;
...
let rec ocaml_app_minmax_vec_i_v
  op svi v1 v2 =
    (let i = integer_of_nat (vec_i_length svi) in
      (match op with Min_vec sx -> V128Wrapper.min_vec i (sx_b sx) v1 v2
        | Max_vec sx -> V128Wrapper.max_vec i (sx_b sx) v1 v2));;

let rec ocaml_app_satop_vec_i_v
  op svi v1 v2 =
    (let i = integer_of_nat (vec_i_length svi) in
      (match op with Add_sat_vec sx -> V128Wrapper.add_sat_vec i (sx_b sx) v1 v2
        | Sub_sat_vec sx -> V128Wrapper.sub_sat_vec i (sx_b sx) v1 v2));;

let rec ocaml_app_relop_vec_i_v
  op svi v1 v2 =
    (let i = integer_of_nat (vec_i_length svi) in
      (match op with Eq_vec -> V128Wrapper.eq_vec_i i v1 v2
        | Ne_vec -> V128Wrapper.ne_vec_i i v1 v2
        | Lt_vec sx -> V128Wrapper.lt_vec_i i (sx_b sx) v1 v2
        | Gt_vec sx -> V128Wrapper.gt_vec_i i (sx_b sx) v1 v2
        | Le_vec sx -> V128Wrapper.le_vec_i i (sx_b sx) v1 v2
        | Ge_vec sx -> V128Wrapper.ge_vec_i i (sx_b sx) v1 v2));;

let rec ocaml_app_relop_vec_f_v
  op svf v1 v2 =
    (let i = integer_of_nat (vec_f_length svf) in
      (match op with Eq_vecf -> V128Wrapper.eq_vec_f i v1 v2
        | Ne_vecf -> V128Wrapper.ne_vec_f i v1 v2
        | Lt_vecf -> V128Wrapper.lt_vec_f i v1 v2
        | Gt_vecf -> V128Wrapper.gt_vec_f i v1 v2
        | Le_vecf -> V128Wrapper.le_vec_f i v1 v2
        | Ge_vecf -> V128Wrapper.ge_vec_f i v1 v2));;

let rec ocaml_app_binop_vec_i_v
  op svi v1 v2 =
    (let i = integer_of_nat (vec_i_length svi) in
      (match op with Add_vec -> V128Wrapper.add_vec_i i v1 v2
        | Sub_vec -> V128Wrapper.sub_vec_i i v1 v2));;

let rec ocaml_app_binop_vec_f_v
  op svf v1 v2 =
    (let i = integer_of_nat (vec_f_length svf) in
      (match op with Add_vecf -> V128Wrapper.add_vec_f i v1 v2
        | Sub_vecf -> V128Wrapper.sub_vec_f i v1 v2
        | Mul_vecf -> V128Wrapper.mul_vec_f i v1 v2
        | Div_vecf -> V128Wrapper.div_vec_f i v1 v2
        | Min_vecf -> V128Wrapper.min_vec_f i v1 v2
        | Max_vecf -> V128Wrapper.max_vec_f i v1 v2
        | Pmin_vecf -> V128Wrapper.pmin_vec_f i v1 v2
        | Pmax_vecf -> V128Wrapper.pmax_vec_f i v1 v2));;

let rec ocaml_app_binop_vec_v
  bop v1 v2 =
    (match bop with Swizzle_i8_16 -> V128Wrapper.swizzle_vec v1 v2
      | Binop_vec_i (op, svi) -> ocaml_app_binop_vec_i_v op svi v1 v2
      | Binop_vec_f (op, svf) -> ocaml_app_binop_vec_f_v op svf v1 v2
      | Minmaxop_i8_16 op -> ocaml_app_minmax_vec_i_v op I8_16 v1 v2
      | Minmaxop_i16_8 op -> ocaml_app_minmax_vec_i_v op I16_8 v1 v2
      | Minmaxop_i32_4 op -> ocaml_app_minmax_vec_i_v op I32_4 v1 v2
      | Satop_i8_16 op -> ocaml_app_satop_vec_i_v op I8_16 v1 v2
      | Satop_i16_8 op -> ocaml_app_satop_vec_i_v op I16_8 v1 v2
      | Mul_i16_8 -> V128Wrapper.mul_vec (Z.of_int 2) v1 v2
      | Mul_i32_4 -> V128Wrapper.mul_vec (Z.of_int 4) v1 v2
      | Mul_i64_2 -> V128Wrapper.mul_vec (Z.of_int 8) v1 v2
      | Avgr_u_i8_16 -> V128Wrapper.avgr_u_vec (Z.of_int 1) v1 v2
      | Avgr_u_i16_8 -> V128Wrapper.avgr_u_vec (Z.of_int 2) v1 v2
      | Q15mulr_sat_s_i16_8 -> V128Wrapper.q15_mulr_sat_s_vec v1 v2
      | Relop_i8_16 op -> ocaml_app_relop_vec_i_v op I8_16 v1 v2
      | Relop_i16_8 op -> ocaml_app_relop_vec_i_v op I16_8 v1 v2
      | Relop_i32_4 op -> ocaml_app_relop_vec_i_v op I32_4 v1 v2
      | Relop_i64_2_eq -> ocaml_app_relop_vec_i_v Eq_vec I64_2 v1 v2
      | Relop_i64_2_ne -> ocaml_app_relop_vec_i_v Ne_vec I64_2 v1 v2
      | Relop_i64_2_lt_s -> ocaml_app_relop_vec_i_v (Lt_vec S) I64_2 v1 v2
      | Relop_i64_2_gt_s -> ocaml_app_relop_vec_i_v (Gt_vec S) I64_2 v1 v2
      | Relop_i64_2_le_s -> ocaml_app_relop_vec_i_v (Le_vec S) I64_2 v1 v2
      | Relop_i64_2_ge_s -> ocaml_app_relop_vec_i_v (Ge_vec S) I64_2 v1 v2
      | Relop_vec_f (op, svf) -> ocaml_app_relop_vec_f_v op svf v1 v2
      | Narrow_i8_16_i16_8 sx ->
        V128Wrapper.narrow_vec (Z.of_int 1) (Z.of_int 2) (sx_b sx) v1 v2
      | Narrow_i16_8_i32_4 sx ->
        V128Wrapper.narrow_vec (Z.of_int 2) (Z.of_int 4) (sx_b sx) v1 v2
      | Dot_s_i32_4_i16_8 ->
        V128Wrapper.dot_s_vec (Z.of_int 4) (Z.of_int 2) v1 v2
      | Extmul_i16_8_i8_16 (h, sx) ->
        V128Wrapper.extmul_vec (Z.of_int 2) (Z.of_int 1) (half_vec_b h)
          (sx_b sx) v1 v2
      | Extmul_i32_4_i16_8 (h, sx) ->
        V128Wrapper.extmul_vec (Z.of_int 4) (Z.of_int 2) (half_vec_b h)
          (sx_b sx) v1 v2
      | Extmul_i64_2_i32_4 (h, sx) ->
        V128Wrapper.extmul_vec (Z.of_int 8) (Z.of_int 4) (half_vec_b h)
          (sx_b sx) v1 v2);;

let rec app_binop_vec_v x = ocaml_app_binop_vec_v x;;
...
let rec ocaml_app_shift_vec_v
  op v i =
    (match op
      with Shl_vec svi ->
        V128Wrapper.shl_vec (integer_of_nat (vec_i_length svi)) v
          (isabelle_int32_to_ocaml_int32 i)
      | Shr_vec (svi, sx) ->
        V128Wrapper.shr_vec (integer_of_nat (vec_i_length svi)) (sx_b sx) v
          (isabelle_int32_to_ocaml_int32 i));;

let rec app_shift_vec_v x = ocaml_app_shift_vec_v x;;
...
let rec ocaml_app_shuffle_vec_v
  is v1 v2 = V128Wrapper.shuffle_vec (map integer_of_nat is) v1 v2;;

let rec app_shuffle_vec_v x = ocaml_app_shuffle_vec_v x;;

let rec app_shuffle_vec
  is v1 v2 =
    (let (ConstVec128 c1, ConstVec128 c2) = (v1, v2) in
      ConstVec128 (app_shuffle_vec_v is c1 c2));;

let rec app_v_s_shuffle_vec
  is v_s =
    (match v_s with [] -> (v_s, crash_invalid)
      | V_num _ :: _ -> (v_s, crash_invalid) | [V_vec _] -> (v_s, crash_invalid)
      | V_vec _ :: V_num _ :: _ -> (v_s, crash_invalid)
      | V_vec v2 :: V_vec v1 :: v_sa ->
        (V_vec (app_shuffle_vec is v1 v2) :: v_sa, Step_normal));;
...
let rec ocaml_app_ternop_vec_v
  op v1 v2 v3 = (let Bitselect_vec = op in V128Wrapper.bitselect_vec v1 v2 v3);;

let rec app_ternop_vec_v x = ocaml_app_ternop_vec_v x;;
...
let rec app_v_s_binop_vec
  op v_s =
    (match v_s with [] -> (v_s, crash_invalid)
      ...
      | V_vec _ :: V_num _ :: _ -> (v_s, crash_invalid)
      | V_vec v2 :: V_vec v1 :: v_sa ->
        (match app_binop_vec op v1 v2
          with None -> (v_sa, Res_trap (name typerep_binop_vec op))
        ...
        | Binop_vec op ->
          (let (v_sa, res) = app_v_s_binop_vec op v_s in
            (fun () ->
              (Config_m (d, s, update_fc_step_m fc v_sa [], fcs), res)))
        | Shuffle_i8_16 is ->
          (let (v_sa, res) = app_v_s_shuffle_vec is v_s in
            (fun () ->
              (Config_m (d, s, update_fc_step_m fc v_sa [], fcs), res)))
        | Ternop_vec op ->
...
let rec split_v_s_b_s_aux
  v_s x1 = match v_s, x1 with
    ...
    | v_s, Shuffle_i8_16 vb :: va -> (v_s, Shuffle_i8_16 vb :: va)
