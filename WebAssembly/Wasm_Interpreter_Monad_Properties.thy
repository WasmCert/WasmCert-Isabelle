...
proof (cases tb)
  case (Tbf tf_i)
  thus ?thesis
    unfolding tb_tf_m_def tb_tf_def inst_store_assn_def inst_at_def inst_m_assn_def
...
proof - 
  ...
  note unfold_for_j = 
    unfold_vars_assns s_m_assn_def inst_at_def inst_store_assn_def list_assn_conv_idx
